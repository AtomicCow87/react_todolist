    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          "button",
          {
            className: "btn btn-outline-danger mb-1 mr-2",
...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=207").then(checkStatus).then(json).then(function (response) {
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=207", {
        method: "POST",
        mode: "cors",
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "?api_key=207", {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "/mark_" + newState + "?api_key=207", {
        method: "PUT",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this6.fetchTasks();
